...
//product - loadView with numberous and curent page
router.get('/products', JwtUtil.checkToken, async function (req, res) {
  //get data
  var products = await ProductDAO.selectAll();
  //pagination
  const sizePage = 5;                                   // Limit of product on view
  const noPages = Math.ceil(products.length / sizePage); // Create page list - Lấy tổng số SP chia cho số SP hiện 1 trang => Số page có thể chia (ceil - Làm tròn lên)
  var curPage = 1;                                      // Biến cho biết Page hiện tại
